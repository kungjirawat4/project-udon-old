...
// export const baseUrl: string = 'http://172.16.2.254:8080';
...
// export default function udhApi({
//   key,
//   method,
//   // scrollMethod,
//   url,
...
export let baseUrl: string = 'http://172.16.2.254:8080';

if (process.env.NODE_ENV === 'production') {
  baseUrl = process.env.UDH_NODE_API_URL as string;
}
