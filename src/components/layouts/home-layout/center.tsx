    ...
    >
      <PageHeader className="pb-8">
        ...
        >
          ...
          {' '}
          <span className="sm:hidden">ระบบบริหารจัดการยาที่กำลังจะมา.</span>
          <span className="hidden sm:inline">
            เราขอแนะนำให้ได้รู้จักกับระบบบริหารจัดการห้องยา.
          </span>
        </Link>
        ...
        >
          ...
          ระบบบริหารจัดการห้องยาประสิทธิภาพสูง.
        </span>
        ...
        <span
          ...
          className="max-w-[750px] text-center text-lg text-muted-foreground"
        >
          เป้าหมายของเรา คือ การสร้างระบบบริหารจัดการยาที่มีประสิทธิภาพ
          แม่ยำและรวดเร็วที่สุดเท่าที่เคยมี.
          <br />
          เริ่มใช้ระบบกันเลย!.
        </span>
        ...
        >
          {' '}
          <Link href="/medicine" className={cn(buttonVariants())}>
            เริ่มต้นใช้งาน
          </Link>
          <Link
            rel="noreferrer"
