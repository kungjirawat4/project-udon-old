...
import { TimeShortTH } from '@/libs/dateTime';
...
//   vacation: 'warning',
// };
export function RecentUser(data: any) {
  const renderCell = React.useCallback((user: any, columnKey: any) => {
    const userStatus = user?.user?.status as UserStatus | undefined;
      ...
      case 'status':
        return (
          ...
          <Chip
            ...
            // color={userStatus ? statusColorMap[userStatus] : 'default'}
            size="sm"
            variant="flat"
          >
            {userStatus || 'Unknown'}
